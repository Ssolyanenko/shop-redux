                ...
                >
                    <div className={s.modal} onClick={(e) => e.stopPropagation()}>
                        <header className={s.modal_header}>
                            <h2 className={s.modal_headerTitle}>{title}</h2>
                            <div className={s.close} >
                            <MyButton onClick={() => close()}>
                                <img className={s.imgC} src="https://avatanplus.com/files/resources/original/5968a2c8f2ed115d40bbe123.png" alt='close' />
                            </MyButton>
                            </div>
                        </header>
